...
_STRINGS = {
    ...
    "es": {
        "Start": "Iniciar", "Stop": "Pausar", "Interval": "Intervalo",
        "Auto-stop": "Parada automática", "Profiles": "Perfiles",
        "Settings": "Configuración", "Changelog": "Historial", "Quit": "Salir",
        "30 seconds": "30 segundos", "1 minute": "1 minuto", "2 minutes": "2 minutos",
        "Custom": "Personalizado", "No limit": "Sin límite",
        "1 hour": "1 hora", "2 hours": "2 horas", "4 hours": "4 horas",
        "No profiles saved": "Sin perfiles guardados",
        "paused": "pausado", "ACTIVE": "ACTIVO",
        "paused (in meeting)": "pausado (en reunión)",
        "paused (low battery)": "pausado (batería baja)",
        "schedule enabled": "horario activo",
        "stops in": "para en",
        "Keep Awake activated": "Keep Awake activado",
        "Keep Awake paused": "Keep Awake pausado",
        "Meeting detected — Keep Awake paused": "Reunión detectada — Keep Awake pausado",
        "Meeting ended — Keep Awake resumed": "Reunión finalizada — Keep Awake reanudado",
        "Charging — Keep Awake resumed": "Cargando — Keep Awake reanudado",
        "Settings saved": "Configuración guardada",
        "Settings exported": "Configuración exportada",
        "Settings imported": "Configuración importada",
        "Profile activated": "Perfil '{name}' activado",
        "Keep Awake — Settings": "Keep Awake — Configuración",
        " General ": " General ", " Schedule ": " Horario ",
        " Profiles ": " Perfiles ", " System ": " Sistema ", " Log ": " Registro ",
        "Interval in seconds (blank = use quick menu selection)": "Intervalo en segundos (vacío = usar selección del menú)",
        "Auto-stop (e.g. 1h30m, 20m, 45s — blank = no limit)": "Parada automática (ej: 1h30m, 20m, 45s — vacío = sin límite)",
        "Enable schedule": "Activar horario",
        "Active days": "Días activos",
        "Time blocks (up to 3)": "Bloques de horario (hasta 3)",
        "Start_label": "Inicio", "End_label": "Fin",
        "Leave Start/End blank to skip a block.": "Deje Inicio/Fin en blanco para omitir el bloque.",
        "Add current": "Agregar actual", "Activate": "Activar",
        "Edit": "Editar", "Update": "Actualizar", "Delete": "Eliminar",
        "Select a profile to see its settings.": "Seleccione un perfil para ver su configuración.",
        "'Add current' saves interval + auto-stop as a new profile.": "'Agregar actual' guarda intervalo + parada automática como nuevo perfil.",
        "Start with Windows": "Iniciar con Windows",
        "Pause during Teams / Zoom meetings": "Pausar durante reuniones de Teams / Zoom",
        "Skip mouse nudge when user is active for less than": "No mover el ratón cuando el usuario lleva menos de",
        "seconds idle": "segundos sin actividad",
        "Pause when battery below": "Pausar cuando la batería esté por debajo de",
        "Theme": "Tema", "Dark": "Oscuro", "Light": "Claro",
        "Language": "Idioma", "English": "English", "Português": "Português",
        "Reset to defaults": "Restaurar valores predeterminados",
        "Global hotkey (toggle)": "Atajo global (alternar)",
        "Click then press a key combo": "Haga clic y presione una combinación de teclas",
        "Press a key combo…": "Presione una combinación…",
        "Hold Ctrl/Shift/Alt, then press a letter": "Mantenga Ctrl/Shift/Alt y presione una letra",
        "Must include Ctrl, Shift, or Alt — try again": "Debe incluir Ctrl, Shift o Alt — inténtelo de nuevo",
        "Only letters A–Z are supported — try again": "Solo se admiten letras A–Z — inténtelo de nuevo",
        "Hotkey captured — click Apply/Save to activate": "Atajo capturado — haga clic en Aplicar/Guardar para activar",
        "Export settings": "Exportar configuración", "Import settings": "Importar configuración",
        "Refresh": "Actualizar", "Chart": "Gráfico", "List": "Lista",
        "Week": "Semana", "Month": "Mes", "Export HTML": "Exportar HTML",
        "Open CSV": "Abrir CSV", "Clear log": "Limpiar registro",
        "No usage log yet.": "Sin registros aún.",
        "Total:": "Total:", "across": "en", "sessions": "sesiones",
        "Save": "Guardar", "Apply": "Aplicar", "Cancel": "Cancelar",
        "New profile": "Nuevo perfil", "Profile name:": "Nombre del perfil:",
        "Rename profile": "Renombrar perfil", "New name:": "Nuevo nombre:",
        "Reset to defaults_title": "Restaurar valores predeterminados",
        "Reset all settings to defaults?\nProfiles will be kept.": "¿Restaurar toda la configuración?\nLos perfiles se conservarán.",
        "Custom Interval": "Intervalo personalizado",
        "Interval (e.g. 30, 90, 120 — seconds):": "Intervalo (ej: 30, 90, 120 — segundos):",
        "Custom Auto-stop": "Parada automática personalizada",
        "Auto-stop (e.g. 1h30m, 20m, 45s — blank = no limit):": "Parada automática (ej: 1h30m, 20m, 45s — vacío = sin límite):",
        "Clear log_title": "Limpiar registro",
        "Delete all usage history permanently?": "¿Eliminar todo el historial de uso permanentemente?",
        "Invalid settings": "Configuración inválida",
        "Interval must be at least 10 seconds.": "El intervalo debe ser de al menos 10 segundos.",
        "Interval must be a number.": "El intervalo debe ser un número.",
        "Auto-stop must be at least 10 seconds.": "La parada automática debe ser de al menos 10 segundos.",
        "Auto-stop: Use formats like: 1h30m, 20m, 45s, 90": "Parada automática: use formatos como: 1h30m, 20m, 45s, 90",
        "times must be numbers.": "los horarios deben ser números.",
        "invalid start time.": "hora de inicio inválida.",
        "invalid end time.": "hora de fin inválida.",
        "start must be before end.": "el inicio debe ser antes del fin.",
        "At least one time block is required when schedule is enabled.": "Se requiere al menos un bloque de horario cuando el horario está activo.",
        "Select at least one day for the schedule.": "Seleccione al menos un día para el horario.",
        "Export failed": "Error al exportar", "Import failed": "Error al importar",
        "Keep Awake is already running.\nCheck the system tray.": "Keep Awake ya está en ejecución.\nRevise la bandeja del sistema.",
        "Mon": "Lun", "Tue": "Mar", "Wed": "Mié", "Thu": "Jue",
        "Fri": "Vie", "Sat": "Sáb", "Sun": "Dom",
        "Interval:": "Intervalo:", "Auto-stop:": "Parada auto:", "Schedule:": "Horario:",
        "on": "activado", "off": "desactivado",
        "Battery at % — Keep Awake paused": "Batería al {pct}% — Keep Awake pausado",
        "Keep-awake methods": "Métodos para mantener activo",
        "System API (prevent sleep / screen off)": "API del sistema (evitar suspensión / pantalla apagada)",
        "Mouse nudge (move cursor 1px)": "Mover ratón (1px)",
        "Key press (Scroll Lock)": "Presionar tecla (Scroll Lock)",
        "Key press": "Presionar tecla",
        "Click then press a key (nudge)": "Haga clic y presione una tecla (nudge)",
        "At least one keep-awake method must be selected.": "Se debe seleccionar al menos un método.",
        "Start paused (do not activate on launch)": "Iniciar pausado (no activar al abrir)",
        "Pause when screen is locked": "Pausar cuando la pantalla esté bloqueada",
        "Screen locked — Keep Awake paused": "Pantalla bloqueada — Keep Awake pausado",
        "Screen unlocked — Keep Awake resumed": "Pantalla desbloqueada — Keep Awake reanudado",
